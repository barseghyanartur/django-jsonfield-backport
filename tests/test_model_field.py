...
@skipUnless(connection.features.supports_json_field, "Only test on supported backends.")
...
class TestSaveLoad(TestCase):
    ...
    @skipUnless(
        connection.features.supports_primitives_in_json_field, "Only test on supported backends.",
    )
...
class TestQuerying(TestCase):
    ...
    @skipUnless(
        connection.features.can_distinct_on_fields, "Only test on supported backends.",
    )
    ...
    @skipUnless(
        connection.features.has_json_operators,
